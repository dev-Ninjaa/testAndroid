...
/// anything.** Register an app named "Maple" at <https://discord.com/developers/applications> and
...
const REPO_URL: &str = "https://github.com/dev-Ninjaa/maple.music";
...
impl Presence {
    ...
    fn push_card(&mut self) {
        ...
        buttons.push(activity::Button::new("Get Maple", REPO_URL));
